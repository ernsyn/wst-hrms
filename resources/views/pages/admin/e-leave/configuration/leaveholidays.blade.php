...
<div class="container">
    ...
    <div class="row pb-3">
        ...
        <div class="col-auto">
            <a role="button" class="btn btn-primary" href="{{ route('admin.e-leave.configuration.leaveholidays.add') }}">
                Add Public Holiday
            </a>
        </div>
    </div>
            ...
            <table class="hrms-data-table compact w-100 t-2" id="holiday-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> 
                            <button onclick="window.location='{{ route('admin.e-leave.configuration.leaveholidays.edit.post', ['id' => $holidays->id]) }}';"
