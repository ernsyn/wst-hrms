                    ...
                    @foreach($leaveRequests as $leaveRequest)
                        <tr>
                            ...
                            <td>@if ($leaveRequest['status'] == 'new')
                                    ...
                                    <button class="btn btn-outline-danger waves-effect" data-toggle="modal" data-leaverequest-id="{{$leaveRequest['id']}}" onclick="window.location='{{ route('admin.e-leave.add-leave-request-disapprove', ['id' => $leaveRequest->id]) }}';">
                                        <span class="fas fa-times-circle"></span>
                                    </button>
                                @else
                                    <button class="btn btn-outline-primary waves-effect" data-toggle="modal" disabled>
                                        <span class="fas fa-check-circle"></span>
                                    </button>
                                    <button class="btn btn-outline-danger waves-effect" data-toggle="modal" disabled>
                                        <span class="fas fa-times-circle"></span>
                                    </button>
                                @endif
                            </td>
