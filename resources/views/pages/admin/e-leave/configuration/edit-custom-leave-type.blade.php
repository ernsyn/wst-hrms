            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" placeholder="eg. ANNUAL"
                            name="code">
                    ...
                    <div class="form-group col-md-9">
                        ...
                        <input type="text" class="form-control" placeholder="eg. Annual Leave"
                            name="name">
...
<script>
    $(function () {
        ...
        (function () {
            ...
            form.find('input[name=code]').val(leaveType.code);
            form.find('input[name=name]').val(leaveType.name);
            form.find('textarea[name=description]').val(leaveType.description);
                    ...
                    if(xhr.status == 422) {
                        ...
                        for (var errorField in errors) {
                            if (errors.hasOwnProperty(errorField)) {
                                ...
                                switch(errorField) {
                                    case 'code':
                                        $('#add-leave-type-form input[name=code]').addClass('is-invalid');
                                        $('#add-leave-type-form #code-error').html('<strong>' + errors[errorField][0] + "</strong>");
                                    break;
                                    case 'name':
                                        $('#add-leave-type-form input[name=name]').addClass('is-invalid');
                                        $('#add-leave-type-form #name-error').html('<strong>' + errors[errorField][0] + "</strong>");
                                    break;
                                    case 'description':
