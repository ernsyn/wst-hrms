                        ...
                        <div class="tab-pane fade show active p-3" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <form>
                                <div class="row">
                                        ...
                                        <div class="row p-3">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" readonly class="text-capitalize form-control-plaintext" value="{{$user->user_id}}">
                                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <button type="button" class="btn btn-primary rounded-circle" data-toggle="modal" data-target="#editProfile">
