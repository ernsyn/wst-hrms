        ...
        <div id="employee-profile-details" class="card-body bg-primary text-white">
            <div class="d-flex align-items-stretch" id="reload-profile1">
                ...
                <div id="end-btn-group">
                    ...
                    <button id="emp-reset-password-btn" data-toggle="modal" data-target="#reset-password-popup" type="button" class="btn btn-sm text-white rounded">
                        {{-- <i class="fas fa-pen"></i> --}}
                        Reset Password
                    </button>
                </div>
    ...
    $(function () {
        ...
        function assignRemoveAdminRole(assign, onSuccess, onFail) {
            $.ajax({
                ...
                data: {
                    _token: '{{ csrf_token() }}',
                    // current_password: $('#reset-password-form input[name=current_password]').val(),
