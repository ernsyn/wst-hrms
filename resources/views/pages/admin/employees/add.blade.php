        ...
        <form method="POST" action="{{ route('admin.employees.add') }}" id="register_employee">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-lg-4 col-form-label text-right">Date of Birth:</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-lg-4 col-form-label text-right">Marital Status:</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label text-right">Nationality:</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-lg-4 col-form-label text-right">Number of Child:</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-lg-4 col-form-label text-right">License Expiry Date:</label>
                            <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label text-right">Employee ID:</label>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label text-right">Department:</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-lg-4 col-form-label text-right">Company:</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-lg-4 col-form-label text-right">Tax No:</label>
                            <div class="col-lg-6">
