                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <label for="name"><strong>Security Group*</strong></label>
                            <input id="security_group_id" type="text" class="form-control" placeholder="" value="" required> {{--
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <label for="name"><strong>Payroll Access*</strong></label>
                            <input id="payroll-access" type="text" class="form-control" >                            {{--
                            <div class="valid-feedback">
                                Looks good!
                            </div> --}}
                            <div id="payroll-access-error" class="invalid-feedback">
...
@section('scripts')
<script>
    var securityGroupTable = $('#security-groups-table').DataTable({
    "bInfo": true,
    "bDeferRender": true,
    "serverSide": true,
    "bStateSave": true,
    ...
    "columns": [{
        ...
        {
            "data": "security_groups.description"
        },
       ...
       $('#add-security-group-form #add-submit').click(function(e){
          ...
          $.ajax({
            ...
            data: {
               ...
               // contact_no: $('#add-security-group-form #contact-no').val()
            },
            success: function(data) {
                showAlert(data.success);
                securityGroupTable.ajax.reload();
                    ...
                    var errors = xhr.responseJSON.errors;
                        ...
                        for (var errorField in errors) {
                            if (errors.hasOwnProperty(errorField)) {
                                ...
                                switch(errorField) {
                                    case 'name':
                                        $('#add-security-group-form #name').addClass('is-invalid');
                                        $('#add-security-group-form #name-error').html('<strong>' + errors[errorField][0] + "</strong>");
                                    break;
                                    case 'relationship':
                                        $('#add-security-group-form #relationship').addClass('is-invalid');
                                        $('#add-security-group-form #relationship-error').html('<strong>' + errors[errorField][0] + "</strong>");
                                    break;
                                    case 'contact_no':
                                        $('#add-security-group-form #contact-no').addClass('is-invalid');
                                        $('#add-security-group-form #contact-no-error').html('<strong>' + errors[errorField][0] + '</strong>');
                                    break;
                                }
                            }
                        }
