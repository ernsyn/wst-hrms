                    ...
                    <div class="row p-3">
                        <div class="form-group row w-100">
                            ...
                            <div class="col-4">
                                ...
                                <div class="col-md-12">
                                           <input id="contact_no_primary" type="text" class="form-control{{ $errors->has('contact_no_primary') ? ' is-invalid' : '' }}" placeholder="Contact No here"
                                        name="contact_no_primary" value="{{ $branch->contact_no_primary }}" required>
                            ...
                            <div class="col-4">
                                ...
                                <div class="col-md-12">
                                        ...
                                        name="contact_no_secondary" value="{{ $branch->contact_no_secondary }}" required>
                            ...
                            <div class="col-4">
                                ...
                                <div class="col-md-12">
                                        <input id="fax_no" type="text" class="form-control{{ $errors->has('fax_no') ? ' is-invalid' : '' }}" 
                                        name="fax_no" value="{{ $branch->fax_no }}" required>
                        ...
                        <div class="form-group row w-100">
                            <div class="col-6">
                                ...
                                <div class="col-md-12">
                                        ...
                                        name="state" value="{{ $branch->state }}" required>
                                        @if ($errors->has('state'))
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-6">
                                ...
                                <div class="col-md-12">
                                        ...
                                        name="city" value="{{ $branch->city }}" required>
                                        @if ($errors->has('city'))
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row w-100">
                            <div class="col-6">
                                ...
                                <div class="col-md-7">
                                        <input id="zip_code" type="text" class="form-control{{ $errors->has('zip_code') ? ' is-invalid' : '' }}" 
                                        name="zip_code" value="{{ $branch->city }}" required>
                            ...
                            <div class="col-6">                                
                                ...
                                <div class="col-md-7">
                                        <input id="country_code" type="text" class="form-control{{ $errors->has('country_code') ? ' is-invalid' : '' }}" 
                                        name="country_code" value="{{ $branch->city }}" required>
