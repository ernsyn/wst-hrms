                            ...
                            <div class="col-md-12">
                                <input id="salary" type="text" class="form-control{{ $errors->has('salary') ? ' is-invalid' : '' }}" placeholder="Name here"
                                    ...
                                    <label class="col-md-12 col-form-label">First Category Employer*</label>
                                            <input id="first_category_employer" type="text" class="form-control{{ $errors->has('first_category_employer') ? ' is-invalid' : '' }}" placeholder="Name here"
                                            name="first_category_employer" value="{{ $socso->first_category_employer }}" required>
                                            ...
                                            <input id="first_category_employee" type="text" class="form-control{{ $errors->has('first_category_employee') ? ' is-invalid' : '' }}" placeholder="Name here"
                                            name="first_category_employee" value="{{ $socso->first_category_employee }}" required>
