    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('admin.settings.teams.add.post') }}" id="add_team">
                    @csrf
                    <div class="row p-3">
...
<div class="modal fade" id="updateTeamPopup" tabindex="-1" role="dialog" aria-labelledby="updateTeamLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('admin.settings.teams.edit.post') }}" id="edit_team">
                    @csrf
                    <div class="row p-3">
                        <div class="form-group row w-100">
        ...
        <div class="card p-4">
            <div class="card-body">
                <div class="row pb-3">
                    ...
                    <div class="col-auto">
                        <button type="button" class="btn btn-outline-primary waves-effect" data-toggle="modal" data-target="#addTeamPopup">
                                Add Team
                    </div>
                </div>
                <div class="row">
