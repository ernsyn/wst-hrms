            ...
            <div class="card-body">
                ...
                <div class="row p-3">
                    <div class="form-group row w-100">
                        ...
                        <div class="col-md-4">
                            <input id="salary" type="text" class="form-control{{ $errors->has('salary') ? ' is-invalid' : '' }}" placeholder="0.00" name="salary"
                    ...
                    <div class="form-group row w-100">
                        ...
                        <div class="col-md-4">
                            <input id="employer" type="text" class="form-control{{ $errors->has('employer') ? ' is-invalid' : '' }}" placeholder="0.00" name="employer"
                    ...
                    <div class="form-group row w-100">
                        ...
                        <div class="col-md-4">
                            <input id="employee" type="text" class="form-control{{ $errors->has('employee') ? ' is-invalid' : '' }}" placeholder="0.00" name="employee"
                    ...
                    <input type="hidden" name="category" value="{{ EisCategoryEnum::FIRST_CATEGORY }}">
                </div>
            </div>
