...
<div class="container">
    ...
    @endforeach
    <div class="card">
        <form method="POST" action="{{ route('admin.settings.cost-centres.edit.post', ['id' => $costs->id]) }}" id="form_validate" data-parsley-validate>
            <div class="card-body">
                @csrf
                <div class="row p-3">
                    <div class="form-group row w-100">
                        <div class="col-4">
                            ...
                            <div class="col-md-12">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Name here"
                                    name="name" value="{{ $costs->name }}" required>
                                    @if ($errors->has('name'))
                        ...
                        <div class="col-6">
                                ...
                                <div class="col-md-12">
                                    <select class="form-control" id="seniority_pay" name="seniority_pay"name="seniority_pay" value="{{ $costs->seniority_pay }}" required>
