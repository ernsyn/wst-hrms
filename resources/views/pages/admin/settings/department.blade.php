    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('admin.settings.departments.add.post') }}" id="add_department">
                    @csrf
                    <div class="row p-3">
...
<div class="modal fade" id="updateDepartmentPopup" tabindex="-1" role="dialog" aria-labelledby="updateDepartmentLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('admin.settings.departments.edit.post') }}" id="edit_visa">
                    @csrf
                    <div class="row p-3">
                        <div class="form-group row w-100">
