...
<div class="main-content">
    ...
    <div class="card">
        <form method="POST" action="{{ route('admin.settings.bank-code.add.post') }}" id="form_validate" data-parsley-validate>
            <div class="card-body">
                @csrf
                <div class="row p-3">
                    ...
                    <div class="form-group row w-100">
                        ...
                        <div class="col-md-4">
                            <input id="bic_code" type="text" class="form-control{{ $errors->has('bic_code') ? ' is-invalid' : '' }}" placeholder="" name="bic_code"
