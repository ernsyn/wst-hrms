...
<div class="main-content">
    ...
    @endif
    @can(PermissionConstant::ADD_EIS) 
    <div class="row pb-3">
            ...
            <table class="hrms-data-table compact w-100 t-2" id="eis-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$eis['employee']}}</td>
                        <td>
                        	@can(PermissionConstant::UPDATE_EIS)
                            <button onclick="window.location='{{ route('admin.settings.eis.edit.post', ['id' => $eis->id]) }}';" class="btn btn-success btn-smt fas fa-edit"></button>
                            @endcan
                            @can(PermissionConstant::DELETE_EIS)
                            <button type="submit" data-toggle="modal" data-target="#confirm-delete-modal" data-entry-title='{{ $eis->salary }}' data-link='{{ route('admin.settings.eis.delete', ['id ' => $eis->id]) }}' class="btn btn-danger btn-smt fas fa-trash-alt"></button>
                            @endcan
                        </td>
                    </tr>
                    @endforeach
...
$(document).ready(function() {
	...
	t.on( 'draw.dt', function () {
	    var PageInfo = $('#eis-table').DataTable().page.info();
