...
<div class="modal fade" id="edit-immigration-popup" tabindex="-1" role="dialog" aria-labelledby="edit-immigration-label"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="edit-immigration-label">View Immigration</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
            </div>
    ...
    var immigrationsTable = $('#employeeImmigrationTable').DataTable({
            ...
            "columns": [{
                ...
                },
                {
                    "data": null,
                    render: function (data, type, row, meta) {
                        return `<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-current="${encodeURI(JSON.stringify(row))}" data-target="#edit-immigration-popup"><i class="far fa-eye"></i></button>`;
