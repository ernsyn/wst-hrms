                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input id="company" type="text" class="form-control" placeholder="" value="" readonly>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input id="position" type="text" class="form-control" placeholder="" value="" readonly>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input id="start-date" type="text" class="form-control" placeholder="" value="" readonly>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input id="end-date" type="text" class="form-control" placeholder="" value="" readonly>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input id="institution" type="text" class="form-control" placeholder="" value="" readonly>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input id="start-year" type="text" class="form-control" placeholder="" value="" readonly>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input id="end-year" type="text" class="form-control" placeholder="" value="" readonly>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input id="level" type="text" class="form-control" placeholder="" value="" readonly>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input id="major" type="text" class="form-control" placeholder="" value="" readonly>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input id="gpa" type="text" class="form-control" placeholder="" value="" readonly>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input id="description" type="text" class="form-control" placeholder="" value="" readonly>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input id="years-of-experience" type="text" class="form-control" placeholder="" value="" readonly>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <select id="competency" type="text" class="form-control" placeholder="" value="" readonly>
...
<div class="modal fade" id="edit-experience-popup" tabindex="-1" role="dialog" aria-labelledby="edit-experience-label" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="edit-experience-label">View Experience</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
            </div>
...
<div class="modal fade" id="edit-education-popup" tabindex="-1" role="dialog" aria-labelledby="edit-education-label" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="edit-education-label">View Education</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
            </div>
...
<div class="modal fade" id="edit-skill-popup" tabindex="-1" role="dialog" aria-labelledby="edit-skill-label" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="edit-skill-label">View Skill</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
            </div>
    ...
    var experiencesTable = $('#employee-companies-table').DataTable({
            ...
            "columns": [{
                ...
                },
                {
                    "data": null,
                    render: function (data, type, row, meta) {
                        return `<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-current="${encodeURI(JSON.stringify(row))}" data-target="#edit-experience-popup"><i class="far fa-eye"></i></button>`;
    ...
    var educationsTable = $('#employee-education-table').DataTable({
        ...
        "columns": [{
            ...
            },
            {
                "data": null,
                render: function (data, type, row, meta) {
                    return `<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-current="${encodeURI(JSON.stringify(row))}" data-target="#edit-education-popup"><i class="far fa-eye"></i></button>`;
    ...
    var skillsTable = $('#employee-skill-table').DataTable({
        ...
        "columns": [{
            ...
            },
            {
                "data": null,
                render: function (data, type, row, meta) {
                    return `<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-current="${encodeURI(JSON.stringify(row))}" data-target="#edit-skill-popup"><i class="far fa-eye"></i></button>`;
...
<script type="text/javascript">
    $(function(){
        ...
        //     e.preventDefault();
        //     $.ajax({
        //         url: "{{ route('employee.companies.post', ['id' => $id]) }}",
        //         type: 'POST',
        //         data: {
        //             _token: '{{ csrf_token() }}',
        //             // Form Data
        ...
        // var editExperienceRouteTemplate = "{{ route('employee.companies.edit.post', ['emp_id' => $id, 'id' => '<<id>>']) }}";
        ...
        // var deleteExperienceRouteTemplate = "{{ route('employee.experiences.delete', ['emp_id' => $id, 'id' => '<<id>>']) }}";
...
<script type="text/javascript">
    $(function(){
            ...
            //     e.preventDefault();
            //     $.ajax({
            //         url: "{{ route('employee.educations.post', ['id' => $id]) }}",
            //         type: 'POST',
            //         data: {
            //             _token: '{{ csrf_token() }}',
            //             // Form Data
            ...
            // var editEducationRouteTemplate = "{{ route('employee.educations.edit.post', ['emp_id' => $id, 'id' => '<<id>>']) }}";
            ...
            // var deleteEducationRouteTemplate = "{{ route('employee.educations.delete', ['emp_id' => $id, 'id' => '<<id>>']) }}";
...
<script type="text/javascript">
    $(function(){
            ...
            //     clearSkillsError('#add-skill-form');
            //     $.ajax({
            //         url: "{{ route('employee.skills.post', ['id' => $id]) }}",
            //         type: 'POST',
            //         data: {
            //             _token: '{{ csrf_token() }}',
            //             // Form Data
            ...
            // var editSkillRouteTemplate = "{{ route('employee.skills.edit.post', ['emp_id' => $id, 'id' => '<<id>>']) }}";
            ...
            // var deleteSkillRouteTemplate = "{{ route('employee.skills.delete', ['emp_id' => $id, 'id' => '<<id>>']) }}";
