    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('employee.companies.post', ['id' => $id]) }}" id="add_qualification_experience">
                    @csrf
                    <div class="row pb-5">
                        <div class="col-xl-8">
...
<div class="modal fade" id="addEducationPopup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('employee.education.post', ['id' => $id]) }}" id="add_qualification_education">
                    @csrf
                    <div class="row pb-5">
                        <div class="col-xl-8">
...
<div class="modal fade" id="addSkillsPopup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('employee.skills.post', ['id' => $id]) }}" id="add_qualification_skills">
                    @csrf
                    <div class="row pb-5">
                        <div class="col-xl-8">
...
<div class="modal fade" id="updateCompanyPopup" tabindex="-1" role="dialog" aria-labelledby="updateCompanyLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('employee.companies.edit', ['emp_id' => $id, 'id' => 1]) }}" id="edit_qualification_company">
                    @csrf
                    <div class="row pb-5">
                        <div class="col-xl-8">
...
<div class="modal fade" id="updateEducationPopup" tabindex="-1" role="dialog" aria-labelledby="updateEducationLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('employee.education.edit', ['emp_id' => $id, 'id' => 1]) }}" id="update_qualification_education">
                    @csrf
                    <div class="row pb-5">
                        <div class="col-xl-8">
...
<div class="modal fade" id="updateSkillsPopup" tabindex="-1" role="dialog" aria-labelledby="updateSkillsLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('employee.immigrations.edit', ['emp_id' => $id, 'id' => 1]) }}" id="edit_qualification_skills">
                    @csrf
                    <div class="row pb-5">
                        <div class="col-xl-8">
