<!-- ADD -->
<div class="modal fade" id="add-employee-bank-account-popup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('employee.immigrations.post', ['id' => $id]) }}" id="add_employee_immigration">
                    @csrf
                    <div class="row pb-5">
                        <div class="col-xl-8">
...
<div class="modal fade" id="updateContactPopup" tabindex="-1" role="dialog" aria-labelledby="updateContactLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('employee.immigrations.edit', ['emp_id' => $id, 'id' => 1]) }}"
                    id="edit_immigration">
                    @csrf
                    <div class="row pb-5">
                        <div class="col-xl-8">
...
<div class="tab-pane fade show p-3" id="nav-bank" role="tabpanel" aria-labelledby="nav-bank-tab">
    <div class="row pb-3">
        ...
        <div class="col-auto">
            <button type="button" class="btn btn-outline-info waves-effect" data-toggle="modal" data-target="#add-employee-bank-account-popup">
                Add Bank
            </button>
        </div>
    </div>
...
@section('scripts')
<script>
    $('#employee-bank-accounts-table').DataTable({
        "bInfo": true,
        "bDeferRender": true,
        "serverSide": true,
        "bStateSave": true,
