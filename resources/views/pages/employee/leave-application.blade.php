                    ...
                    <div class="container-fluid">
                        <form  method="POST" action="{{ route('add_leave_application') }}" id="add_leave_application" data-parsley-validate>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select name="type-balance" id="type-balance" onchange="document.getElementById('department-form').submit()" class="custom-select" required data-required-message="Please select leave type">                               
                                        <option selected disabled>Select Leave</option>
                                        @foreach($leavebalance as $type)
