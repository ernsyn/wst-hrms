...
<div id="page-container">
        ...
        <tr>
            <td class="tg-s268" rowspan="6">
                <div class="text_center" style="font-size: 13pt;font-weight: bold">LEMBAGA HASIL DALAM NEGERI MALAYSIA
                    <br>PEMBERITAHUAN PEMBERHENTIAN KERJA
                    </div>
            ...
            <td class="tg-s268">
                <div class="text_left" style="font-size: 10pt;">CP22B (Pin. 1/2015)</div>
            </td>
        </tr>
        <tr>
            <td class="tg-s268"></td>
    ...
    <table class="pf padded" style="margin-top: 5pt;">
        <tr>
            <td class="table-header-black" colspan="19">
                ...
                <br>
                &nbsp;&nbsp;&nbsp;&nbsp;<b>- dalam tempoh enam (6) bulan sebelum seseorang pekerja bersara; atau</b>
                <br>
    ...
    <table class="pf padded table-border" style="margin-top: 20pt;">
        ...
        <tr>
            ...
            <td class="border_right"></td>
            <td class="tg-0lax"></td>
            <td class="table-border pleft10 text_padding">{{$data->getTelNoA()}}</td>
            <td class="tg-0lax"></td>
        </tr>
        <tr>
            <td class="tg-s268"></td>
        ...
        <tr>
            ...
            <td class="border_right"></td>
            <td class="tg-0lax"></td>
            <td class="table-border pleft10 text_padding">Poskod : {{$data->getPostcodeA()}}</td>
            <td class="tg-0lax"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="border_right"></td>
            <td class="tg-0lax"></td>
            <td class="table-border pleft10 text_padding">{{$data->getLegalRepresentativeNameA()}}</td>
            <td class="tg-0lax"></td>
        </tr>
        <tr>
            <td class="tg-0lax"></td>
        ...
        <tr>
            ...
            <td class="table-border pleft text_padding">{{$data->getMarriedStatusA()}}</td>
            <td class="border_right"></td>
            <td class="tg-0lax"></td>
            <td class="">
                <div class="table-border " style="height: 12pt;float: left; padding-top: 1pt;padding-bottom: 1pt; padding-left: 5pt; padding-right: 5pt;">
        ...
        <tr>
            ...
            <td class="border_right"></td>
            <td class="tg-0lax"></td>
            <td class="table-border pleft10 text_padding">{{$data->getLegalRepresentativeAddress1A()}}</td>
            <td class="tg-0lax"></td>
        </tr>
        <tr>
            <td class="tg-0lax"></td>
            ...
            <td class="border_right"></td>
            <td class="tg-0lax"></td>
            <td class="table-border pleft10 text_padding">{{$data->getLegalRepresentativeAddress2A()}}</td>
            <td class="tg-0lax"></td>
        </tr>
        <tr>
            <td class="pleft5"></td>
            ...
            <td class="border_right"></td>
            <td class="tg-0lax"></td>
            <td class="table-border pleft10 text_padding">{{$data->getLegalRepresentativeAddress3A()}}</td>
            <td class="tg-0lax"></td>
        </tr>
        <tr>
            <td class="pleft5"></td>
        ...
        <tr>
            <td class="pleft5"></td>
            <td class="table-border pleft5 text_padding" colspan="2">{{$data->getSpouseNameA()}}</td>
            <td class="border_right"></td>
            <td class="pleft10"></td>
            <td class="pleft5">
                <div style="float: left;">
        ...
        <tr>
            <td class="tg-0lax"></td>
            <td class="table-border pleft5 text_padding" colspan="2"></td>
            <td class="border_right"></td>
            <td class="tg-0lax"></td>
            <td class="pleft5"></td>
            <td class="tg-0lax"></td>
    ...
    <table class="pf padded" style="margin-top: 10pt;">
        <tr>
            <th class="table-header-black border_right border_left" colspan="5">B. BUTIR-BUTIR SARAAN</th>
        </tr>
        ...
        <tr class="border_bottom border_left border_right">
            ...
            <td class="tg-s268" style="border-left-style: none;">
                Gaji, bayaran, upah-upah dan kerja lebih masa
            </td>
            <td class="text_center border_right border_left" valign="top">{{$data->getSalaryFromB()}}</td>
        ...
        <tr class="border_bottom border_right border_left">
            ...
            <td class="tg-s268" style="border-left-style: none;">Gaji cuti</td>
            <td class="text_center border_right border_left" valign="top">{{$data->getLeavePayFromB()}}</td>
        ...
        <tr class="border_bottom border_right border_left">
            ...
            <td class="tg-s268" style="border-left-style: none;">Komisen dan Bonus</td>
            <td class="text_center border_right border_left" valign="top">{{$data->getCommissionFromB()}}</td>
        ...
        <tr class="border_bottom border_right border_left">
            ...
            <td class="tg-s268" style="border-left-style: none;">Ganjaran</td>
            <td class="text_center border_right border_left" valign="top">{{$data->getGratuityFromB()}}</td>
        ...
        <tr class="border_bottom border_right border_left">
            ...
            <td class="tg-s268" style="border-left-style: none;">Pampasan kerana kehilangan pekerjaan</td>
            <td class="text_center border_right border_left" valign="top">{{$data->getCompensationFromB()}}</td>
        ...
        <tr class="border_bottom border_right border_left">
            ...
            <td class="tg-s268" style="border-left-style: none;">Elaun tunai termasuk cukai ditanggung oleh majikan <br> (sebutkan jenis-jenis elaun) .....................</td>
            <td class="text_center border_right border_left" valign="top">{{$data->getCashAllowanceFromB()}}</td>
        ...
        <tr class="border_bottom border_right border_left">
            ...
            <td class="tg-s268" style="border-left-style: none;">Pencen daripada majikan</td>
            <td class="text_center border_right border_left" valign="top">{{$data->getPensionFromB()}}</td>
        ...
        <tr class="border_bottom border_right border_left">
            ...
            <td class="tg-s268" style="border-left-style: none;">Manfaat berupa barangan yang layak dikenakan cukai</td>
            <td class="text_center border_right border_left" valign="top">{{$data->getBenefitSubjectToTaxFromB()}}</td>
        ...
        <tr class="border_bottom border_right border_left">
            <td class="pleft" style="border-right-style: none;" valign="top">9)</td>
            <td class="tg-s268" style="border-left-style: none;">Elaun-elaun selain dari wang seperti makanan, pakaian, lojing atau <br> pembantu rumah yang diperuntukkan atau dibayar oleh majikan</td>
            <td class="text_center border_right border_left" valign="top">{{$data->getOtherAllowanceFromB()}}</td>
        ...
        <tr class="border_bottom border_right border_left">
            ...
            <td class="tg-s268" style="border-left-style: none;">Kereta dan pemandu</td>
            <td class="text_center border_right border_left" valign="top">{{$data->getTransportFromB()}}</td>
            <td class="text_center border_right" valign="top">{{$data->getTransportUntilB()}}</td>
            <td class="text_center" valign="top">{{$data->getTransportAmountB()}}</td>
        </tr>
        <tr class="border_bottom border_right border_left">
            <td class="pleft" style="border-right-style: none;" valign="top">11)</td>
            <td class="tg-s268" style="border-left-style: none;">Lain-lain bayaran (jika ada,nyatakan) <br> ............................................................................</td>
            <td class="text_center border_right border_left" valign="top">{{$data->getOtherPaymentsFromB()}}</td>
    ...
    <table class="pf padded" style="margin-top: 10pt;">
        <tr>
            <th class="table-header-black border_left border_right" colspan="5">C. BUTIR-BUTIR PENDAPATAN YANG BELUM DILAPORKAN</th>
        </tr>
        <tr class="border_bottom border_right border_left">
    ...
    <table class="pf padded" style="margin-top: 10pt;">
        <tr>
            <th class="table-header-black border_left border_right" colspan="4">D. BUTIR-BUTIR LAIN</th>
        </tr>
        <tr class="border_bottom border_right border_left">
    ...
    <table class="pf padded" style="margin-top: 10pt;">
        <tr>
            <th class="table-header-black border_right border_left" colspan="3">E. AKUAN PEGAWAI YANG DIBERI KUASA</th>
        </tr>
        <tr class="border_bottom border_right border_left">
