...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/report/soscoLampiranA/base.min.css')}}"/>
    <link rel="stylesheet" href="{{asset('css/report/soscoLampiranA/main.css')}}"/>
    <style type="text/css">
    </style>
    <title></title>
</head>
...
<div id="page-container">
    <div id="pf1" class="pf w0 h0">
        <div class="pc pc1 w0 h0">
            <img class="bi x0 y0 w1 h1" alt="" src="{{asset('img/report/soscoLampiranA.png')}}"/>
            ...
            <div class="t m0 x3 h4 y4 ff1 fs1 fc0 sc0 ls2 ws0">CARUMAN MENGGUNAKAN PITA/DISKET UNTUK  BULAN <span class="_ _0"></span><span class="ls3"> {{$data->getFromMonth()}}  {{$data->getYear()}}<span class="_ _0"></span><span class="ls4">  HINGGA  <span class="_ _0"></span></span>{{$data->getToMonth()}}  {{$data->getYear()}}</span></div>
            ...
            <div class="t m0 x4 h3 y9 ff1 fs0 fc0 sc0 ls0 ws0"> No : <span class="ff2">{{$data->getNoCheck()}}</span> <span>disertakan</span> <span class="_ _2"> </span><span class="ff2"><b> RM  576.30</b></span></div>
            <div class="t m0 x5 h2 ya ff1 fs0 fc0 sc0 ls0 ws0"> Kod Majikan<span class="_ _3"> </span>:<span class="_ _4"></span>B3200090304M</div>
            <div class="t m0 x5 h2 yb ff1 fs0 fc0 sc0 ls0 ws0"> Nama Majikan<span class="_ _5"> </span>:<span class="_ _4"></span>OPPO ELECTRONICS SDN BHD  1075187-D</div>
            <div class="t m0 x5 h2 yc ff1 fs0 fc0 sc0 ls0 ws0"> Alamat<span class="_ _6"> </span>:<span class="_ _4"></span>LEVEL 15, TOWER 1, PJ 33,</div>
            <div class="t m0 x6 h2 yd ff1 fs0 fc0 sc0 ls0 ws0">:<span class="_ _4"></span>JALAN SEMANGAT, SEKSYEN 13, PETALING JAYA,</div>
            <div class="t m0 x6 h2 ye ff1 fs0 fc0 sc0 ls0 ws0">:<span class="_ _4"></span>SELANGOR. Poskod: 46200</div>
            <div class="t m0 x4 h2 yf ff1 fs0 fc0 sc0 ls0 ws0"> Tandatangan <span class="_ _5"> </span>: </div>
            <div class="t m0 x4 h2 y10 ff1 fs0 fc0 sc0 ls0 ws0"> Nama Penuh <span class="_ _3"> </span>: <span class="_ _7"></span>CHONG HWEE MIN</div>
            <div class="t m0 x4 h2 y11 ff1 fs0 fc0 sc0 ls0 ws0"> Telefon <span class="_ _8"> </span>: <span class="_ _7"></span>03-7931 3550</div>
