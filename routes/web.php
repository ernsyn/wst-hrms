...
Route::group(['middleware' => ['auth', 'role:employee']], function() {
    ...
    Route::post('employees/{emp_id}/emergency-contacts','Admin\EmployeeController@postEmergencyContact')->name('employees.emergency-contacts.post')->where('id', '[0-9]+');
});
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'role:super-admin|admin']], function() {
    ...
    Route::get('employees/{id}','Admin\EmployeeController@securityGroupDisplay')->name('admin.employees.id.security-group')->where('id', '[0-9]+');
