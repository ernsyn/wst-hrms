...
class LhdnCP22aBean
{
    ...
    private $dateOptionGranted_B;
    private $dateOptionGrantedArr;
    private $dateExistingOptionCanExecuted_B;
    private $dateExistingOptionCanExecutedArr;
    private $dateOptionExecuted_B;
    private $dateOptionExecutedArr;
    private $totalBenefit;
    ...
    public function __construct(array $array = []) {
        ...
        $this->dateOptionGranted_B = isset($array['dateOptionGranted_B']) ? $array['dateOptionGranted_B'] : null;
        $this->dateExistingOptionCanExecuted_B = isset($array['dateExistingOptionCanExecuted_B']) ? $array['dateExistingOptionCanExecuted_B'] : null;
        $this->dateOptionExecuted_B = isset($array['dateOptionExecuted_B']) ? $array['dateOptionExecuted_B'] : null;
        $this->totalBenefit = isset($array['totalBenefit']) ? $array['totalBenefit'] : null;
     ...
     * @return mixed
     */
    public function getDateOptionGrantedB()
    {
        return $this->dateOptionGranted_B;
    }

    /**
     * @param mixed $dateOptionGranted_B
     */
    public function setDateOptionGrantedB($dateOptionGranted_B): void
    {
        $this->dateOptionGranted_B = $dateOptionGranted_B;
    }

    public function getDateOptionGrantedArr(){
        if(strlen($this->dateOptionGranted_B) != 0){
            $this->dateOptionGrantedArr = str_split($this->dateOptionGranted_B);
            return $this->dateOptionGrantedArr;
        }else{
            return $this->dateOptionGrantedArr = array();
        }
    }
     ...
     * @return mixed
     */
    public function getDateExistingOptionCanExecutedB()
    {
        return $this->dateExistingOptionCanExecuted_B;
    }

    /**
     * @param mixed $dateExistingOptionCanExecuted_B
     */
    public function setDateExistingOptionCanExecutedB($dateExistingOptionCanExecuted_B): void
    {
        $this->dateExistingOptionCanExecuted_B = $dateExistingOptionCanExecuted_B;
    }

    public function getDateExistingOptionCanExecutedArr(){
        if(strlen($this->dateExistingOptionCanExecuted_B) != 0){
            $this->dateExistingOptionCanExecutedArr = str_split($this->dateExistingOptionCanExecuted_B);
            return $this->dateExistingOptionCanExecutedArr;
        }else{
            return $this->dateExistingOptionCanExecutedArr = array();
        }
    }
     ...
     * @return mixed
     */
    public function getDateOptionExecutedB()
    {
        return $this->dateOptionExecuted_B;
    }

    /**
     * @param mixed $dateOptionExecuted_B
     */
    public function setDateOptionExecutedB($dateOptionExecuted_B): void
    {
        $this->dateOptionExecuted_B = $dateOptionExecuted_B;
    }

    public function getDateOptionExecutedArr(){
        if(strlen($this->dateOptionExecuted_B) != 0){
            $this->dateOptionExecutedArr = str_split($this->dateOptionExecuted_B);
            return $this->dateOptionExecutedArr;
        }else{
            return $this->dateOptionExecutedArr = array();
        }
    }
    ...
    /**
     * @param mixed $totalBenefit
     */
    public function setTotalBenefit($totalBenefit): void
    {
    ...
    public function toArray() {
        return [
            ...
            'dateOptionGranted_B' => $this->dateOptionGranted_B,
            'dateExistingOptionCanExecuted_B' => $this->dateExistingOptionCanExecuted_B,
            'otherPaymentsAmount_B' => $this->otherPaymentsAmount_B,
            'dateOptionExecuted_B' => $this->dateOptionExecuted_B,
