...
class AttendanceController extends Controller
{
    ...
    public function getCurrentDayAttendance()
    {
        ...
        foreach ($attendances as $row) {
            ...
            $result_array[$row->id]['clock_in_time'] = Carbon::parse($row->clock_in_time)->format('g:i:s A');
            ...
            $result_array[$row->id]['clock_out_time'] = $row->clock_out_time ? Carbon::parse($row->clock_out_time)->format('g:i:s A') : 'N/A';
    ...
    public function getAttendanceReport($date = null)
    {
        ...
        foreach ($attendances as $row) {
            ...
            $result_array[$row->id]['clock_in_time'] = $row->clock_out_time ? Carbon::parse($row->clock_in_time)->format('g:i:s A') : 'N/A';
