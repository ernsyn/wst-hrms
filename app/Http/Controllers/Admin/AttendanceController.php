...
class AttendanceController extends Controller
{
    ...
    public function getCurrentDayAttendance()
    {
        ...
        ->whereDate('employee_clock_in_out_records.clock_in_time', \Carbon\Carbon::today())
        ->get();
        ...
        foreach ($attendances as $row) {
            ...
            $result_array[$row->id]['clock_in_time'] = $row->clock_in_time;
            ...
            $result_array[$row->id]['clock_out_time'] = $row->clock_out_time;
            ...
            if($media_out) {
                ...
                $media_out_image = 'http://placehold.jp/24/cccccc/ffffff/300x300.png?text=NA';
            }

            $result_array[$row->id]['clock_in_media'] = 'data:'.$media_in->mimetype.';base64,'.$media_in->data;
