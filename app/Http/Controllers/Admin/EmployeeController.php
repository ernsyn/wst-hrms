...
use App\Helpers\ExportEmployeeHelper;
...
//             $sheet->getStyle('A:U')->getAlignment()->setWrapText(true);
    ...
    {
        $spreadsheet = new Spreadsheet();
        ExportEmployeeHelper::generateProfileSheet($spreadsheet);
        ExportEmployeeHelper::generateDisciplinaryIssueSheet($spreadsheet);
        ExportEmployeeHelper::generateEmergencySheet($spreadsheet);
        ExportEmployeeHelper::generateDependentSheet($spreadsheet);
        ExportEmployeeHelper::generateImmigrationSheet($spreadsheet);
        ExportEmployeeHelper::generateVisaSheet($spreadsheet);
        ExportEmployeeHelper::generateJobSheet($spreadsheet);
        ExportEmployeeHelper::generateBankSheet($spreadsheet);
        ExportEmployeeHelper::generateQualificationSheet($spreadsheet); 
        ExportEmployeeHelper::generateReportToSheet($spreadsheet);
        ExportEmployeeHelper::generateSecurityGroupSheet($spreadsheet);
        ExportEmployeeHelper::generateCountrySheet($spreadsheet);
        ExportEmployeeHelper::generateCategorySheet($spreadsheet);
        ExportEmployeeHelper::generateSecuritySheet($spreadsheet);
        ExportEmployeeHelper::generateCostCentreSheet($spreadsheet);
        ExportEmployeeHelper::generateDepartmentSheet($spreadsheet);
        ExportEmployeeHelper::generateTeamSheet($spreadsheet);
        ExportEmployeeHelper::generatePositionSheet($spreadsheet);
        ExportEmployeeHelper::generateGradeSheet($spreadsheet);
        ExportEmployeeHelper::generatSectionSheet($spreadsheet);
        ExportEmployeeHelper::generateCompanySheet($spreadsheet);
        ExportEmployeeHelper::generateBranchSheet($spreadsheet);
        ExportEmployeeHelper::generateStatusSheet($spreadsheet);
        ExportEmployeeHelper::generateRoleSheet($spreadsheet);
        ExportEmployeeHelper::generateBankListSheet($spreadsheet);
        ExportEmployeeHelper::generateEmployeeSheet($spreadsheet);
        ExportEmployeeHelper::generatePayrollSheet($spreadsheet);
          
        ExportEmployeeHelper::hideSheets($spreadsheet);
    ...
    {
        $spreadsheet = new Spreadsheet();
        $profiles = ExportEmployeeHelper::generateProfileSheet($spreadsheet);
        $disciplines = ExportEmployeeHelper::generateDisciplinaryIssueSheet($spreadsheet);
        $emergencies = ExportEmployeeHelper::generateEmergencySheet($spreadsheet);
        $dependents = ExportEmployeeHelper::generateDependentSheet($spreadsheet);
        $immigrations = ExportEmployeeHelper::generateImmigrationSheet($spreadsheet);
        $visas = ExportEmployeeHelper::generateVisaSheet($spreadsheet);
        $jobs = ExportEmployeeHelper::generateJobSheet($spreadsheet);
        $banks = ExportEmployeeHelper::generateBankSheet($spreadsheet);
        $qualifications = ExportEmployeeHelper::generateQualificationSheet($spreadsheet);
        $reportTo = ExportEmployeeHelper::generateReportToSheet($spreadsheet);
        $securityGroup = ExportEmployeeHelper::generateSecurityGroupSheet($spreadsheet);
        ExportEmployeeHelper::generateCountrySheet($spreadsheet);
        ExportEmployeeHelper::generateCategorySheet($spreadsheet);
        ExportEmployeeHelper::generateSecuritySheet($spreadsheet);
        ExportEmployeeHelper::generateCostCentreSheet($spreadsheet);
        ...
        ExportEmployeeHelper::generateProfilesData($profiles);
        ExportEmployeeHelper::generateDisciplinaryIssuesData($disciplines);
        ExportEmployeeHelper::generateEmergencyData($emergencies);
        ExportEmployeeHelper::generateDependentData($dependents);
        ExportEmployeeHelper::generateImmigrationData($immigrations);
        ExportEmployeeHelper::generateVisaData($visas);
        ExportEmployeeHelper::generateJobData($jobs);
        ExportEmployeeHelper::generateBankData($banks);
        ExportEmployeeHelper::generateQualificationData($qualifications);
        ExportEmployeeHelper::generateReportToData($reportTo);
        ExportEmployeeHelper::generateSecurityGroupData($securityGroup);
